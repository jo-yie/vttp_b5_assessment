...
public class Bike {
	...
	public int getTotalCyclists() { return this.totalCyclists; }

	public static Bike toBikeEntry(String[] cols) {
		Bike entry = new Bike();
        ...
        entry.setTotalCyclists(toInt(cols[8]) + toInt(cols[9]));
		return entry;
	}
